  ...
  return (
    <div className="fixed inset-0 min-h-screen flex items-center justify-center bg-neutral-950 p-8 z-[99999]">
      <motion.div
        ...
        className={`max-w-lg w-full text-center space-y-8 p-10 rounded-[2.5rem] border backdrop-blur-3xl shadow-2xl ${
      ...
      >
        <div
          className={`mx-auto w-20 h-20 rounded-3xl flex items-center justify-center border shadow-lg ${
            result.overall_status === "PASSED"
        ...
        <div>
          ...
          <p className="text-neutral-400 text-sm">
            Your results have been securely transmitted to the hiring team.
          </p>
        </div>
